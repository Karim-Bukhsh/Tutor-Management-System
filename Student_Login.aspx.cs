...
namespace TMS_Project
{
    public partial class Student_Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "Select * from StudentSignUp where username = @username and password = @password"; // variable for store procedure
            ...
            if (dr.HasRows == true)
            {
                ...
                Session["std_username"] = txtUsername.Text;
                Response.Redirect("Student/std_Index.aspx");
            }
            else
            {
